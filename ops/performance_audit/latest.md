...
- Generated UTC: `2026-07-21T12:26:17.981127+00:00`
- Catalog: `108.3 KB` across `22` AOIs
- JS bundle in `.next/static`: `1.9 MB` across `29` files
- CSS bundle in `.next/static`: `123.7 KB` across `3` files
- `public/data`: `269.9 MB` across `74668` files
...
- AOI list before active AOI data: `108.3 KB`
- Default AOI vector/VLM plus catalog: `1.0 MB`
...
- Public data remaining after remote tiles/chips are excluded: `16.6 MB`
...
- public/data is 269.9 MB, above the raw package target 119.2 MB
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| `emsr884-aoi00-central-coastal-venezuela` | `imagery-only` | 541 B | 0 B | 0 B | 0 | - |
| `emsr884-aoi01-petare` | `imagery-only` | 503 B | 0 B | 0 B | 0 | - |
...
| `emsr884-aoi04-maracay` | `imagery-only` | 505 B | 0 B | 0 B | 0 | - |
...
| `emsr884-aoi07-puerto-cabello` | `imagery-only` | 519 B | 0 B | 0 B | 0 | - |
...
| `emsr884-aoi09-valencia` | `imagery-only` | 507 B | 0 B | 0 B | 0 | - |
| `emsr884-aoi10-guacara` | `imagery-only` | 340 B | 0 B | 0 B | 0 | - |
| `emsr884-aoi11-villa-de-cura` | `imagery-only` | 517 B | 0 B | 0 B | 0 | - |
