...
- Generated UTC: `2026-07-21T12:26:22.768110+00:00`
- Result: `pass`
- Catalog: `108.3 KB` / `195.3 KB`
- Initial AOI list bytes: `108.3 KB` / `244.1 KB`
- Default AOI metadata+damage+VLM bytes: `1.0 MB` / `1.9 MB`
- Local public data: `269.9 MB` target `119.2 MB`
...
- Public data after excluding local tiles/chips: `16.6 MB` / `71.5 MB`
- Large local AOI files: `0` / `0 B`
- Eager all-AOI data detected: `False`

## Warnings

- public/data is above target (269.9 MB > 119.2 MB); use remote-asset package for production
