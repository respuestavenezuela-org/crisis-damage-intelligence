...
- Generated UTC: `2026-07-21T04:23:53.511563+00:00`
- Result: `pass`
- Catalog: `65.3 KB` / `195.3 KB`
- Initial AOI list bytes: `65.3 KB` / `244.1 KB`
- Default AOI metadata+damage+VLM bytes: `981.3 KB` / `1.9 MB`
- Local public data: `267.6 MB` target `119.2 MB`
...
- Public data after excluding local tiles/chips: `14.2 MB` / `71.5 MB`
- Large local AOI files: `0` / `0 B`
- Eager all-AOI data detected: `False`

## Warnings

- public/data is above target (267.6 MB > 119.2 MB); use remote-asset package for production
