...
INTERNAL REVIEW ONLY. OpenStreetMap footprint candidate, not official EMS damage. VLM before/after output is a triage aid only; absence/presence here is not confirmation.
